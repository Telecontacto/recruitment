...
export default function PdfViewer({ data }: { data: any[] }) {
    ...
    useEffect(() => {
        // Automatically trigger PDF export when component loads
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto print:p-4 print:max-w-none bg-white shadow-md print:shadow-none">
            <div ref={contentRef}>
                ...
                <div className="flex justify-between items-center mb-8 print:mb-4 border-b pb-4">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Application ID: {data[0].ID}</p>
                            <p className="text-gray-600">Submitted: {formatDate(data[0].Fecha)}</p>
                        </div>
                    </div>
                ...
                <section className="mb-8 print:mb-4">
                    <h2 className="text-xl font-bold mb-4 bg-gray-100 p-2 print:bg-gray-200">Personal Information</h2>
                ...
                <section className="mb-8 print:mb-4 page-break-before">
                    <h2 className="text-xl font-bold mb-4 bg-gray-100 p-2 print:bg-gray-200">Work & Hours Information</h2>
                ...
                {/* Languages & Education */}
                <section className="mb-8 print:mb-4">
                    <h2 className="text-xl font-bold mb-4 bg-gray-100 p-2 print:bg-gray-200">Languages & Education</h2>
                ...
                {/* Previous Employment */}
                <section className="mb-8 print:mb-4 page-break-before">
                    <h2 className="text-xl font-bold mb-4 bg-gray-100 p-2 print:bg-gray-200">Previous Employment</h2>
                    <div className="border p-3 rounded">
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="bg-gray-50">
                ...
                {/* Footer */}
                <footer className="mt-8 pt-4 border-t text-center text-gray-500 text-sm print:mt-4">
