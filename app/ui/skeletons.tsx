// Loading animation
const shimmer =
  'before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_2s_infinite] before:bg-gradient-to-r before:from-transparent before:via-white/60 before:to-transparent dark:before:via-gray-700';

export function AttendantSkeleton() {
  return (
    <div
  ...
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-200 dark:bg-gray-700 p-2 md:pt-0">
...
export function PipelineSkeleton() {
  return (
    <div className={`${shimmer} relative overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800 p-2 shadow-sm`}>
      <h2 className="mb-4 h-8 w-36 rounded-md bg-gray-200 dark:bg-gray-700"></h2>
